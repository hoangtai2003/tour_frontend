                ...
                <Row className='justify-content-center align-items-center'>
                    <Col lg="8" className='custom-register-row'>
                        <div className="register-card">
                            <h2 className="register-title">Đăng ký làm dịch vụ khách sạn</h2>
                            <Form onSubmit={onSubmit} style={{marginTop: "40px"}}>
                                <div className='form-controller'>
                                    <FormGroup className='form-group'>
                                        <label className='font-bold'>Tên khách sạn <span>*</span></label>
                                        <input type="text" placeholder="Nhập tên khách sạn" className="login-input" name='username' required onChange={handleChange} />
                                    </FormGroup>
                                    <FormGroup className='form-group'>
